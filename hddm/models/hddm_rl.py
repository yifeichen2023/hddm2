...
def wienerRL_like_uncertainty(x, v0, v1, v2, v_interaction, z0, z1, z2, z_interaction, lambda_, alpha, pos_alpha, gamma, c, rho, a,z,sz,t,st,v,sv, a_2, z_2, t_2,v_2,alpha2,
    ...
    # if
    print("wiener_like_rlddm_uncertainty")
